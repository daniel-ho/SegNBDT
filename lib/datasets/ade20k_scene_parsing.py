...
class ADE20KSceneParsing(BaseDataset):
    def __init__(self, 
                 root,
                 list_path,
                 num_samples=None, 
        ...
        super(ADE20KSceneParsing, self).__init__(ignore_label, base_size,
    ...
    def read_files(self):
        ...
        for item in self.img_list:
            image_path = item['fpath_img'].replace('ADEChallengeData2016', 'ade20k_scene_parsing')
            label_path = item['fpath_segm'].replace('ADEChallengeData2016', 'ade20k_scene_parsing')
